...
3. 🔄 語音輸入支援 — **reordered ahead of #4–#11 on 2026-07-14 at the user's explicit request** (originally Phase 3B #11). Do not revert this ordering or treat #4–#11 as next just because ROADMAP.md's original numbering suggested it. See the Phase 3B table in `ROADMAP.md` for the full remaining ordered list: location DB enrichment, fallback locations, multi-night comparison, gear tips, location wishlist review workflow, cloud-sea/fog mode, sun/moon/planet scenes, 15-day calendar upgrade, comet live coordinates, Meteoblue seeing evaluation, IMO live ZHR, Southern Cross constraint.
