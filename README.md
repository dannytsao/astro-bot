...
| 🟡 中 | 銀河構圖方位 | 計算銀河核心與地標的相對方位角 |
| 🟡 中 | 自動化更新流程 | GitHub Actions 排程讀取反饋，自動產生程式碼修改方案 |
| 🟢 低 | 查詢記錄分析 | 哪些地點／標的最熱門 |
| 🟢 低 | 支援更多天體 | 月出月落、行星、日食月食 |
...
部署於 Render（Background Worker），24 小時持續運行。
